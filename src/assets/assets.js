...
export const projects = [
  {
    ...
    description: "A full-featured online store with shopping cart, user authentication, and payment.",
    image: projectImg1,
  ...
  {
    title: "Chat App",
    description: "A real-time chat application with group messaging, emojis, and file sharing mode support.",
    image: projectImg5,
